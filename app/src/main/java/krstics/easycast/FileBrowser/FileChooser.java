...
public class FileChooser extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Device device = null;
        try {
            device = Environment3.getSecondaryExternalStorage();
        } catch (NoSecondaryStorageException e) {
            e.printStackTrace();
        }

        assert device != null;
        currentDir = device.getFile();

        Log.i("Dir path", String.valueOf(currentDir));
        fill(currentDir);
    }
    private void fill(File f)
    {
        ...
        adapter = new FileArrayAdapter(FileChooser.this, R.layout.item_row,dir);
